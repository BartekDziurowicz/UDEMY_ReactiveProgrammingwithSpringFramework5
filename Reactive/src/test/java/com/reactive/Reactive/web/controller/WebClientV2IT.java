...
import com.reactive.Reactive.web.functional.BeerRouterConfig;
...
public class WebClientV2IT {
    ...
    void getBeerByUpc() throws InterruptedException {
        ...
        Mono<BeerDto> beerDtoMono = webClient.get().uri(BeerRouterConfig.BEER_V2_URL + "Upc/" + upc)
                .accept(MediaType.APPLICATION_JSON)
                .retrieve().bodyToMono(BeerDto.class);
    ...
    void getBeerByUpcNotFound() throws InterruptedException {
        ...
        Mono<BeerDto> beerDtoMono = webClient.get().uri(BeerRouterConfig.BEER_V2_URL + "Upc/" + "fake_upc")
                .accept(MediaType.APPLICATION_JSON)
                .retrieve().bodyToMono(BeerDto.class);
